...
<?php
 ...
 $sql="SELECT idReserva,Fecha,Hora,Origen,Destino,ViaOpcional,tarifa.TipoVehiculo,Tiempo,Distancia,Valor,Cliente.Nombre,Estado,vehiculo.Placa FROM reserva
 INNER JOIN cliente ON (Cliente.idCLiente=reserva.idCliente) 
 INNER JOIN tarifa ON (tarifa.idTarifa=reserva.idTarifa) 
 INNER JOIN vehiculo ON (vehiculo.idVehiculo=reserva.idVehiculo)
 WHERE cliente.idCliente=$sesion ORDER BY idReserva ";
