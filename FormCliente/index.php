    ...
    <div class="page-wrapper" id="page-top">
                ...
                <div class="collapse navbar-collapse">
                  <ul class="nav navbar-nav navbar-nav-center">
                    ...
                    <li data-uk-dropdown="" class="uk-parent">
                      <a href="index.html">more <i class="uk-icon-caret-down"></i></a>
                ...
                <div class="item active">
				  ...
				  <div class="container-fluid">
                    <div class="carousel-caption">
                      <p class="lead uk-text-black">we are</p>
                      <p class="lead-large uk-text-white">the best</p>
                      <p class="lead uk-text-black">in town</p>
                      <a class="btn btn-lg os-btn os-btn-white" href="index.html#">order cab now</a>
                    </div>
                  </div>
		        </div>
                <div class="item">
				  ...
				  <div class="container-fluid">
                    <div class="carousel-caption">
                      <p class="lead-large uk-text-white">rush our</p>
                      <p class="lead uk-text-yellow">who you gonna call?</p>
				  ...
				  <div class="container-fluid">
                    <div class="carousel-caption carousel-caption-phone">
				      <table class="table">
                        <tr>
                          <td>					    
					        <p class="lead uk-text-black">save time with</p>
                            <p class="lead uk-text-yellow">city cab app!</p>
                            <a class="btn btn-lg os-btn os-btn-black" href="index.html#">download now</a></td>
            ...
            <div class="col-md-12">
			  ...
			  <div>
			    <ul class="nav nav-tabs nav-tabs-center cc-nav-tabs">
                  <li class="active"><a data-toggle="tab" href="index.html#town-taxi">Town Taxi</a></li>
                  <li><a data-toggle="tab" href="index.html#hybrid-taxi">Hybrid Taxi</a></li>
                  <li><a data-toggle="tab" href="index.html#limousine-taxi">Limousine Taxi</a></li>
                ...
                <div class="tab-content">
				    ...
				    <div class="uk-grid uk-grid-divider uk-text-center">
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Base Rate:<h3 class="uk-text-white">$2</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Per Mile/ Km:<h3 class="uk-text-white">$1.5</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Class:<h3 class="uk-text-white">small/ town car</h3>
                        </div>
					  </div>
                    </div>                
				  </div>
                  <div id="hybrid-taxi" class="tab-pane fade">
				    ...
				    <div class="uk-grid uk-grid-divider uk-text-center">
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Base Rate:<h3 class="uk-text-white">$3</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Per Mile/ Km:<h3 class="uk-text-white">$2.5</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Class:<h3 class="uk-text-white">family car</h3>
                        </div>
					  </div>
                    </div>					
				  </div>
                  <div id="limousine-taxi" class="tab-pane fade">
				    ...
				    <div class="uk-grid uk-grid-divider uk-text-center">
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Base Rate:<h3 class="uk-text-white">$5</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Per Mile/ Km:<h3 class="uk-text-white">$4.5</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Class:<h3 class="uk-text-white">limousine</h3>
                        </div>
					  </div>
                    </div>	                
				  </div>
                  <div id="suv-taxi" class="tab-pane fade">
	                <img alt="SUV Taxi" src="images/suv.jpg" title="SUV Taxi">
				      <div class="uk-grid uk-grid-divider uk-text-center">
                        <div class="uk-width-medium-1-3">
					      <div class="uk-panel uk-panel-box uk-panel-box-primary">
                            Base Rate:<h3 class="uk-text-white">$7</h3>
                          </div>
					    </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
                          Per Mile/ Km:<h3 class="uk-text-white">$6.5</h3>
                        </div>
					  </div>
                      <div class="uk-width-medium-1-3">
					    <div class="uk-panel uk-panel-box uk-panel-box-primary">
	  ...
	  <section class="book-taxi" id="book-taxi">
        <div class="container">
	      <div class="row">                        
            <div class="col-md-6">
              <div> <h3 class="header book-now">book taxi now</h3>
              </div>
			  <div>
                <form class="form-horizontal" role="form" action="form_process/book-now.htm" method="post">
                  <div class="form-group">
                    <label for="inputWhen" class="control-label label-left col-xs-3">when *</label>
                    <div class="col-xs-9">
                      <input type="date" class="form-control" id="inputWhen" name="when">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputHour" class="control-label label-left col-xs-3">hour *</label>
                    <div class="col-xs-9">
                      <input type="time" class="form-control" id="inputHour" name="hour">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputStartDestination" class="control-label label-left col-xs-3">start destination *</label>
                    <div class="col-xs-9">
                      <input type="text" class="form-control" id="inputStartDestination" placeholder="start destination" name="startDestination">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="inputEndDestination" class="control-label label-left col-xs-3">end destination *</label>
                    <div class="col-xs-9">
                      <input type="text" class="form-control" id="inputEndDestination" placeholder="end destination" name="endDestination">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-xs-9">
                      <div class="radio">
                        <label><input type="radio" name="chooseVehicle" value="town">town</label>
                      </div>
                      <div class="radio">
                        <label><input type="radio" name="chooseVehicle" value="hybrid">hybrid</label>
                      </div>
                      <div class="radio">
                        <label><input type="radio" name="chooseVehicle" value="limousine">limousine</label>
                      </div>
                      <div class="radio">
                        <label><input type="radio" name="chooseVehicle" value="suv">suv</label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label label-left col-xs-3" for="phoneNumber">phone *</label>
                    <div class="col-xs-9">
